...
from inference.dbff import DBFF
...
class AGRNet(GraspModel):
    ...
    def __init__(self, input_channels=4, output_channels=1, channel_size=32, dropout=False, prob=0.0):
        ...
        self.dbff3 = DBFF(channel_size * 4)
        self.dbff5 = DBFF(channel_size * 4)
    ...
    def forward(self, x_in):
        ...
        x3_attn = x3 * (1 + self.dbff3(x3) * self.attn_weight)
        x5_attn = x5 * (1 + self.dbff5(x5) * self.attn_weight)

        fused = torch.cat([x3_attn, x5_attn], dim=1)
